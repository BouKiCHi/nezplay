...
static Int32 DMGSoundSquareRender(void *p, DMG_SQUARE *ch)
{
	DMGSOUND *sndp = p;
...
static Int32 DMGSoundWaveMemoryRender(void *p, DMG_WAVEMEMORY *ch)
{
	DMGSOUND *sndp = p;
...
static Int32 DMGSoundNoiseRender(void *p, DMG_NOISE *ch)
{
	DMGSOUND *sndp = p;
