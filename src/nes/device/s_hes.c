...
static void HESSoundWaveMemoryRender(void *sp, HES_WAVEMEMORY *ch, Int32 *p)
{
	HESSOUND *sndp = sp;
...
static void HESSoundLfoStep(void *p)
{
	HESSOUND *sndp = p;
...
static void HESSoundChReset(void *p, HES_WAVEMEMORY *ch, Uint32 clock, Uint32 freq)
{
	int i;
